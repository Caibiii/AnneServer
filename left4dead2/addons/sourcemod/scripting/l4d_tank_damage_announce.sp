...
public OnPluginStart()
{
		...
		iTankHealth = CreateConVar("z_tank_health", "6000");
...
public Event_TankSpawn(Handle:event, const String:name[], bool:dontBroadcast)
{
		...
		{
			SetEntProp(client, Prop_Send, "m_iMaxHealth",g_hCvarSurvivorLimit * 1500);
			SetEntProp(client, Prop_Send, "m_iHealth",g_hCvarSurvivorLimit * 1500);
		}
