...
public void OnPluginStart()
{
	...
	RegConsoleCmd("sm_rpg", HandleCmdSRS);
	...
	// Combo ConVar
	g_hCvar_combo_level_sound_on = CreateConVar("srs_combo_level_sound_on", "0", "Combo Level Up sound.\n0=OFF, 1=ON", CVAR_FLAGS);
	g_hCvar_combo_level_effect_on = CreateConVar("srs_combo_level_effect_on", "0", "Combo Level Up effect.\n0=OFF, 1=ON", CVAR_FLAGS);
	g_hCvar_combo_time = CreateConVar("srs_combo_time", "2.0", "0=off\nCombo time", CVAR_FLAGS);
	...
	g_hCvar_country_tag = CreateConVar("srs_country_tag", "0", "Add [--] country tag before the name?\n0=Off, 1=On", CVAR_FLAGS);
	g_hCvar_rank_tag = CreateConVar("srs_rank_tag", "0", "Add [Rank.X] tag before the name?\n0=Off, 1=On", CVAR_FLAGS);
	...
	g_hCvar_difficulties[2] = CreateConVar("srs_difficulty_hard", "1.0", "How many score multiply/divide in hard difficulty?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_difficulties[3] = CreateConVar("srs_difficulty_impossible", "1.0", "How many score multiply/divide in impossible difficulty?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	...
	g_hCvar_scores[SRS_S_K_CI] = CreateConVar("srs_s_k_ci_score", "0.5", "How many score for killing a common infected? (Survivor)", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_SK] = CreateConVar("srs_s_k_sk_score", "2.8", "How many score for killing a Smoker? (Survivor)", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_B] = CreateConVar("srs_s_k_b_score", "1.8", "How many score for killing a Boomer? (Survivor)", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_H] = CreateConVar("srs_s_k_h_score", "2.8", "How many score for killing a Hunter? (Survivor)", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_ST] = CreateConVar("srs_s_k_st_score", "1.8", "How many score for killing a Spitter? (Survivor)", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_J] = CreateConVar("srs_s_k_j_score", "2.8", "How many score for killing a Jockey? (Survivor)", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_C] = CreateConVar("srs_s_k_c_score", "2.8", "How many score for killing a Changer? (Survivor)", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_W] = CreateConVar("srs_s_k_w_score", "5.0", "How many score for killing a Witch? (Survivor)", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_T] = CreateConVar("srs_s_k_t_score", "5.0", "How many score for killing a Tank? (Survivor)", CVAR_FLAGS);

	g_hCvar_scores[SRS_S_K_CI_HS] = CreateConVar("srs_s_k_ci_hs_score", "0.5", "How many score for killing a common infected by headshot? (Survivor)", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_SK_HS] = CreateConVar("srs_s_k_sk_hs_score", "2.8", "How many score for killing a Smoker? (Survivor) by headshot", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_B_HS] = CreateConVar("srs_s_k_b_hs_score", "1.8", "How many score for killing a Boomer? (Survivor) by headshot", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_H_HS] = CreateConVar("srs_s_k_h_hs_score", "2.8", "How many score for killing a Hunter? (Survivor) by headshot", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_ST_HS] = CreateConVar("srs_s_k_st_hs_score", "1.8", "How many score for killing a Spitter? (Survivor) by headshot", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_J_HS] = CreateConVar("srs_s_k_j_hs_score", "2.8", "How many score for killing a Jockey? (Survivor) by headshot", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_C_HS] = CreateConVar("srs_s_k_c_hs_score", "2.8", "How many score for killing a Changer? (Survivor) by headshot", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_W_HS] = CreateConVar("srs_s_k_w_hs_score", "5.0", "How many score for killing a Witch? (Survivor) by headshot", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_T_HS] = CreateConVar("srs_s_k_t_hs_score", "5.0", "How many score for killing a Tank? (Survivor) by headshot", CVAR_FLAGS);

	g_hCvar_scores[SRS_S_K_W_OS] = CreateConVar("srs_s_k_w_os_score", "5.0", "How many score for killing a Witch in one shot? (Survivor)", CVAR_FLAGS);

	g_hCvar_scores[SRS_S_K_SMG] = CreateConVar("srs_s_k_smg", "1.2", "How many score multiply/divide for killing a ci/si by smg?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_SILENCED] = CreateConVar("srs_s_k_silenced", "1.2", "How many score multiply/divide for killing a ci/si by SMG silenced?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_MP5] = CreateConVar("srs_s_k_mp5", "1.2", "How many score multiply/divide for killing a ci/si by mp5?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_M16] = CreateConVar("srs_s_k_m16", "1.0", "How many score multiply/divide for killing a ci/si by m16?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_DESERT] = CreateConVar("srs_s_k_desert", "1.0", "How many score multiply/divide for killing a ci/si by Desert?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	...
	g_hCvar_scores[SRS_S_K_M60] = CreateConVar("srs_s_k_m60", "1.0", "How many score multiply/divide for killing a ci/si by m60?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_HUNTING] = CreateConVar("srs_s_k_hunting", "1.0", "How many score multiply/divide for killing a ci/si by Hunting?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_MILITARY] = CreateConVar("srs_s_k_military", "1.0", "How many score multiply/divide for killing a ci/si by Military?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_SCOUT] = CreateConVar("srs_s_k_scout", "1.0", "How many score multiply/divide for killing a ci/si by Scout?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_AWP] = CreateConVar("srs_s_k_awp", "1.0", "How many score multiply/divide for killing a ci/si by Awp?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_PUMP] = CreateConVar("srs_s_k_pump", "1.2", "How many score multiply/divide for killing a ci/si by pump?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_CHROME] = CreateConVar("srs_s_k_chrome", "1.2", "How many score multiply/divide for killing a ci/si by chrome?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_AUTO] = CreateConVar("srs_s_k_auto", "1.0", "How many score multiply/divide for killing a ci/si by auto?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_SPAS] = CreateConVar("srs_s_k_spas", "1.0", "How many score multiply/divide for killing a ci/si by spas?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_PISTOL] = CreateConVar("srs_s_k_pistol", "1.2", "How many score multiply/divide for killing a ci/si by pistol?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_MAGNUM] = CreateConVar("srs_s_k_magnum", "1.2", "How many score multiply/divide for killing a ci/si by magnum?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	...
	g_hCvar_scores[SRS_S_K_KATANA] = CreateConVar("srs_s_k_katana", "1.0", "How many score multiply/divide for killing a ci/si by katana?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_AXE] = CreateConVar("srs_s_k_axe", "1.0", "How many score multiply/divide for killing a ci/si by AXE?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_MACHATE] = CreateConVar("srs_s_k_machate", "1.0", "How many score multiply/divide for killing a ci/si by machate?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_KNIFE] = CreateConVar("srs_s_k_knife", "1.0", "How many score multiply/divide for killing a ci/si by knife?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_SAW] = CreateConVar("srs_s_k_saw", "1.0", "How many score multiply/divide for killing a ci/si by saw?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_PITCHFORK] = CreateConVar("srs_s_k_pitchfork", "1.0", "How many score multiply/divide for killing a ci/si by pitchfork?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_SHOVEL] = CreateConVar("srs_s_k_shovel", "1.0", "How many score multiply/divide for killing a ci/si by shovel?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_GOLF] = CreateConVar("srs_s_k_golf", "1.0", "How many score multiply/divide for killing a ci/si by golf?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_GUITAR] = CreateConVar("srs_s_k_guitar", "1.0", "How many score multiply/divide for killing a ci/si by guitar?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_TONFA] = CreateConVar("srs_s_k_tonfa", "1.0", "How many score multiply/divide for killing a ci/si by tonfa?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_BASEBALL] = CreateConVar("srs_s_k_tonfa", "1.0", "How many score multiply/divide for killing a ci/si by baseballc?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_CRICKET] = CreateConVar("srs_s_k_cricket", "1.0", "How many score multiply/divide for killing a ci/si by cricket?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_PAN] = CreateConVar("srs_s_k_pan", "1.0", "How many score multiply/divide for killing a ci/si by Pan?\n1.0=No Multiply/Divide", CVAR_FLAGS);
	g_hCvar_scores[SRS_S_K_CROWBAR] = CreateConVar("srs_s_k_crowbar", "1.0", "How many score multiply/divide for killing a ci/si by crowbar?\n1.0=No Multiply/Divide", CVAR_FLAGS);
...
public void CallDBAgent(SRS_DBA action, int client)
{
	if (g_db != null)
	{
		...
		switch (action)
		{
			...
			{
				char longQuery[4096];
				Format(longQuery, sizeof(longQuery), "UPDATE SRS SET Name='%s',Score=%.3f,MaxScore=%.3f,PlayedTime=%.1f,LastUpdatedDate=LOCALTIME,ComboSound=%b,ComboEffect=%b,Auto_Open=%d", name, g_players[client].fScore[SRS_TYPE_DB], g_players[client].fMaxScore, g_players[client].fPlayedTime[SRS_TYPE_DB], g_players[client].combo.bSound, g_players[client].combo.bEff, g_players[client].bAutoOpen);
...
public void SetPlayerinfo(DBResultSet rs, Player p, int[][][] srsEntity, bool isTop10)
{
	...
	p.bAutoOpen = rs.FetchInt(read++);    // n+0
...
{
	if(IsValidClientAndHuman(client) && g_players[client].fPlayedTime[SRS_TYPE_DB] > 30.0)
	{
		CallDBAgent(DBA_SAVE, client);
	}	
}
...
public void OpenSRSPanel(Player pMe, Player p, int[][][] srsEntity)
{
	...
	{
		case SRS_TYPE_MVP_BOT, SRS_TYPE_MVP: 
		{
			Format(line, sizeof(line), "关闭菜单");
			CloseSRSPanel(g_players[pMe.id]);
		}
		case SRS_TYPE_DB_BOT, SRS_TYPE_DB: 
		{
			Format(line, sizeof(line), "关闭菜单");
	...
	if(pMe.iPanelPage[PG_PANEL] == 0)
	{
		...
		{
			Format(line, sizeof(line), "%s%T", !pMe.bET[ET_OPTIONS]?"其他": "其他", "OPTIONS", pMe.id);
			panel.DrawItem(line);
			if(pMe.bET[ET_OPTIONS])
			{
				//5
				Format(line, sizeof(line), "出门近战");
				panel.DrawItem(line);
				//6
				Format(line, sizeof(line), "购物商店");
				panel.DrawItem(line);
				//7
				Format(line, sizeof(line), "天梯排行");
				panel.DrawItem(line);
			}
			panel.DrawText(" ");
		}
	...
	else if(pMe.iPanelPage[PG_PANEL] == lastPage)
	{
		...
		panel.DrawText("===========================");
		panel.DrawText(" ");
		panel.DrawText("          Statistic Ranking System          ");
		Format(line, sizeof(line), "                Version: %s      ", PLUGIN_VERSION);
		panel.DrawText(line);
		panel.DrawText("      药役服: 47.119.16.67:27015         ");
		panel.DrawText("      药役服: 47.119.16.67:27016         ");
		panel.DrawText("      战役服: 106.53.198.31:27015         ");
		panel.DrawText("      战役服: 106.53.198.31:27016         ");
		panel.DrawText(" ");
		DrawPrev(panel, pMe, false);
	}
	DrawClose(panel, pMe);
...
public Action:AddStrength(client, args) 
{
	if (args < 1)
	{
		g_players[client].bAutoOpen += 1;
		if(g_players[client].bAutoOpen + 1 > 6)
		{
			g_players[client].bAutoOpen = 0;
		}
		MenuFunc_AddStatus(client);
		return Plugin_Handled;
	}
...
public Action:MenuFunc_AddStatus(Client)
{
	new Handle:menu = CreatePanel();
	decl String:line[256];
	Format(line, sizeof(line), "B数: %f", g_players[Client].fScore[SRS_TYPE_DB]);
	SetPanelTitle(menu, line);
	Format(line, sizeof(line), "出门近战 (%d/%d)", g_players[Client].bAutoOpen, 5);
	DrawPanelItem(menu, line);
...
{	
	...
	SetMenuTitle(menu, "B数:%f",g_players[Client].fScore[SRS_TYPE_DB]);
	...
	switch (action) 
	{
		case MenuAction_Select: 
		{
			...
			switch(StringToInt(item)) 
			{
				...
				case MAGNUM:	
				{	
					if(g_players[param1].fScore[SRS_TYPE_DB] < 50.0)
					{ 
					...
					else
					{
						...
						g_players[param1].fScore[SRS_TYPE_DB] -= 50.0;
				...
				{	
					...
					else if(g_players[param1].fScore[SRS_TYPE_DB] < 50.0)
					{ 
						PrintToChat(param1,"\x03你自己心里没有点B数吗?");
					}
					else
				...
				case AUTOSHOTGUN1:
				{
					if(g_players[param1].fScore[SRS_TYPE_DB] < 200.0)
					{ 
						PrintToChat(param1,"\x03你自己心里没有点B数吗?");
					} 
					else
					{
						...
						g_players[param1].fScore[SRS_TYPE_DB] -= 200.0;
				...
				case AWP:
				{
					if(g_players[param1].fScore[SRS_TYPE_DB] < 500.0)
					{
						PrintToChat(param1,"\x03你自己心里没有点B数吗?");
					} 
					else
					{
						...
						g_players[param1].fScore[SRS_TYPE_DB] -= 500.0;
				...
				case sniperscout:
				{
					if(g_players[param1].fScore[SRS_TYPE_DB] < 300.0)
					{ 
						PrintToChat(param1,"\x03你自己心里没有点B数吗?");
					} 
					else
					{
						...
						g_players[param1].fScore[SRS_TYPE_DB] -= 300.0;
				...
				case PAINPILLS:
				{
					if(g_players[param1].fScore[SRS_TYPE_DB] < 400.0)
					{
						PrintToChat(param1,"\x03你自己心里没有点B数吗?");
					} 
					else
					{
						...
						g_players[param1].fScore[SRS_TYPE_DB] -= 400.0;
				...
				case DEFIBRILLATOR:
				{
					...
					else
					{
						...
						g_players[param1].fScore[SRS_TYPE_DB] -= 500.0;
						PrintToChatAll("\x04%N\x03花了500点B数购买了电击器",param1);
						SaveAll();
					}
				}
			}
...
{	
	...
	switch(type)
	{
		case ARMS:
		{
			SetMenuTitle(menu, "B数:%i", g_players[Client].fScore[SRS_TYPE_DB]);
		...
		case PROPS:
		{
			...
			Format(money,sizeof(money),"电击器(%d点B数)",500);
